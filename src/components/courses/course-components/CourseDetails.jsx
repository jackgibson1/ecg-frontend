...
const CourseDetails = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: '10. Electrodes Vs Leads', component: <UnderstandingTwelveLeads /> }, { title: '11. Electrodes', component: <UnderstandingElectrodes /> }, { title: '12. Leads', component: <UnderstandingLeads /> }, { title: '13. 12-Lead ECG Video Summary', component: <UnderstandingTwelveLeadVideo /> },
